...
#SBATCH --job-name=blastn_summarise
#SBATCH --ntasks=1                      
...
# #SBATCH --job-name=blastn_$sample
# #SBATCH --ntasks=1                      
# #SBATCH --cpus-per-task=12          
# #SBATCH --time=128:00:00
# #SBATCH --mem=300G
...
# echo "blastn -query $file -db $DBNAME -outfmt 0 -num_alignments 1 -num_descriptions 1 -out $OUT/output/$sample.txt -num_threads 12" >> sub.sh
